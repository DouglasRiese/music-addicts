    ...
    <Background>
        <Backdrop>
            <div class="wrapper">
                ...
                <button
                    @click="nextPiece"
                    class="item2 p-2 text-xl mb-6 font-bold bg-white/30 hover:bg-white/40"
                >
                    Next
                </button>
                <div v-if="userInfoStore.isLoggedIn">
                    ...
                    <ButtonBar class="item5" v-slot="{ counter }">
                        ...
                        <ButtonItem
                            :group-name="'r1'"
                            :counter="counter()"
                            @click="selectedStatus = 'for-later'"
                    ...
                    <br />
                    <button
                        @click="addToMyMelodies"
                        class="item6 p-1 mt-3 text-l mb-3 font-bold bg-white/30 hover:bg-white/40"
                    >
                        Add to My Melodies
                    </button>
                </div>
